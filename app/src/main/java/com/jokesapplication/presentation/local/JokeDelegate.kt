...
class JokeDelegate(private val callback: Callback) : AdapterDelegate<MutableList<Joke>>() {
    override fun onCreateViewHolder(parent: ViewGroup): RecyclerView.ViewHolder =
        JokeVH.create(callback, parent)

    override fun isForViewType(items: MutableList<Joke>, position: Int): Boolean = true
